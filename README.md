...
The second option creates the need to use "this" if you want doOneThing to be able to call doTwoThings. This then leads to the practice of *self = this*, for example, to cache the context to access doTwoThings from inside a setTimeout in doOneThing. We can avoid this completely by making them *private* functions and exporting them in an object. 
